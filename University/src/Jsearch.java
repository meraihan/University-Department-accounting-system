...
public class Jsearch extends JComboBox
{
	...
	public static void main(String[] args)
	{
		...
		Jsearch box = new Jsearch(INSTALLED_LOCALES, false);
	...
	* The Default Model is a TreeSet which is alphabetically sorted and doesnt allow
	...
	public Jsearch(Object[] items, boolean caseSensitive)
	{
		super(items);
	...
	* The Default Model is a TreeSet which is alphabetically sorted and doesnt allow
	duplicates.	 * @param items	 */
	public Jsearch(Vector items, boolean caseSensitive)
	{
		super(items);
		model = new ComboBoxModel(items);
		setModel(model);
	...
	* @param caseSensitive	 */
	public Jsearch(boolean caseSensitive)
	{
		super();
		setEditable(true);
		setEditor(new AutoCompleteEditor(this, caseSensitive));
